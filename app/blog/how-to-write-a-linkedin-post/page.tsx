...
export const metadata: Metadata = {
  ...
  alternates: {
    canonical:
      "https://postcraftai-next.vercel.app/blog/how-to-write-a-linkedin-post",
  },
  openGraph: {
    title: "How to Write a LinkedIn Post That Gets Noticed (2025 Guide)",
    description:
...
const jsonLd = {
  ...
  description:
    "Learn how to write a LinkedIn post step by step — hooks, structure, length, hashtags, and CTAs.",
  author: {
    "@type": "Organization",
    name: "PostCraft AI",
    url: "https://postcraftai-next.vercel.app",
  },
  publisher: {
    "@type": "Organization",
    name: "PostCraft AI",
...
function H2({ id, children }: { id: string; children: React.ReactNode }) {
  return (
    <h2 id={id} className="text-2xl font-bold text-gray-900 mt-12 mb-4">
      {children}
    </h2>
  );
}
    ...
    <>
      ...
      <main className="max-w-3xl mx-auto px-4 py-12">
        ...
        <nav className="text-sm text-gray-400 mb-6" aria-label="Breadcrumb">
          ...
          {" › "}
          <span className="text-gray-600">How to Write a LinkedIn Post</span>
        </nav>
        ...
        <nav
          ...
          className="bg-gray-50 border border-gray-200 rounded-lg p-5 mb-10"
        >
        ...
        {/* ── Body ── */}
        <article>
          <H2 id="why-linkedin-posts-matter">
          ...
          <ul className="space-y-2 mb-6 text-gray-700 text-sm">
            {[
              {
                type: "Bold statement",
                example: '"Cold outreach is dead. Here\'s what works instead."',
              },
              {
                type: "Surprising stat",
                example: '"93% of LinkedIn posts get zero engagement. Here\'s why."',
              },
              {
                type: "Relatable frustration",
                example:
                  '"I spent 3 years writing LinkedIn posts that nobody read. This changed everything."',
              },
              {
                type: "Contrarian take",
                example:
                  '"Stop optimizing your LinkedIn profile. Focus on this instead."',
              },
              {
                type: "Story opener",
                example:
                  '"Two years ago I had 200 followers and zero job offers from LinkedIn."',
              },
            ].map(({ type, example }) => (
          ...
          <ul className="space-y-2 mb-6 text-gray-700 text-sm list-none">
            {[
          ...
          <P>
            There's no single "best" length — it depends on your content. A
            compelling story can hold attention at 2,000 characters. A thin post
            padded to 1,000 characters loses readers. Write until you've said
            what you need to say, then stop.
          </P>

          <H2 id="hashtags">How to Use Hashtags on LinkedIn</H2>
          <P>
            LinkedIn hashtags work differently from Instagram or Twitter. Using
            too many signals low-quality spam content to the algorithm. Best
            practice:
          </P>
          <ul className="space-y-2 mb-6 text-gray-700 text-sm">
            {[
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-4 font-mono text-sm text-gray-700 leading-relaxed whitespace-pre-line">
...
#BuildInPublic #SaaS #Founders`}
          ...
          <div className="bg-gray-50 border border-gray-200 rounded-lg p-4 mb-6 font-mono text-sm text-gray-700 leading-relaxed whitespace-pre-line">
...
#LinkedInTips #ContentStrategy`}
          ...
          <P>
            Writing LinkedIn posts consistently is the hardest part — not the
            skill, the habit. An{" "}
            <Link
              href="/linkedin-post-writer"
              className="text-blue-600 hover:underline"
            >
              AI LinkedIn post writer
            </Link>{" "}
            removes the blank screen problem. You describe your idea, the AI
            drafts the structure, and you edit it into your voice.
          </P>
          <P>
            PostCraft AI generates full LinkedIn posts — hook, body, CTA — in
            under 3 seconds. It scores your hook, lets you regenerate individual
            sections, and shows a live preview. The free plan gives you 3 posts
            per day with no credit card required.
          </P>

          {/* ── CTA ── */}
          <div className="bg-blue-50 border border-blue-100 rounded-xl p-6 mt-8 text-center">
            <h2 className="text-xl font-bold text-gray-900 mb-2">
              Try the free AI LinkedIn post writer
            </h2>
            <p className="text-gray-600 mb-4 text-sm">
              Generate your first post in under 10 seconds. Free forever, no
              card needed.
            </p>
            <Link
              href="/generate"
